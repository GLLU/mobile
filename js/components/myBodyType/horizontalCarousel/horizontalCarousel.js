...
export default class HorizontalCarousel extends Component {
    ...
    render() {
        ...
        if (!this.props.children) {
            body = (
                <TouchableWithoutFeedback>
                    <View style={ [ {flex: 1}, computedStyles.page, this.props.pageStyle ] }>
                        <Text style={ {flex: 1} }>
            ...
            body = children.map((c, index) => {
                return (
                    ...
                    >
                        <View
                            style={ [ {flex: 1}, computedStyles.page, this.props.pageStyle ] }
                        >
                            { c }
                        </View>
                    </TouchableWithoutFeedback>
        ...
        return (
            <View style={[ {flex: 1, justifyContent: "center", alignSelf: "stretch"}, this.props.containerStyle ]}>
                <ScrollView
