      ...
      <View style={styles.container}>
        <View style={styles.filter}>
          <View style={{flex: 1, flexDirection: 'row'}}>
            <Button transparent onPress={() => this.toggleFilter()} style={styles.btnFilter}>
          ...
          <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-end', paddingRight: 5}}>
            <Button transparent onPress={() => this.clearFilter()} style={[styles.btnReset]} textStyle={styles.TextlabelReset}>
              RESET
              </Button>
            {this.state.isOpen ?
              <Button transparent iconRight onPress={() => this._handleCloseFilter()} style={[styles.btnCloseFilter]}>
                  <Icon name={this.state.filterStatusIcon} style={[styles.smallBtn]} />
              </Button>
              :
              null
            }
